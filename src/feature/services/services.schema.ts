...
export type ServiceCategory = 'all' | 'government' | 'legal-aid' | 'dispute-resolution' | 'specialized';
...
export const legalServicesTable = pgTable(
  "legal_services",
  {
...
export const legalServiceResponseSchema = createSelectSchema(legalServicesTable, {
...
export const serviceCategorySchema = z.enum(['all', 'government', 'legal-aid', 'dispute-resolution', 'specialized']);
