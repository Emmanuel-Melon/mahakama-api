...
const chatResourceSchema = createJsonApiResourceSchema('chat', chatSessionResponseSchema);
const chatSingleResponseSchema = createJsonApiSingleResponseSchema(chatResourceSchema);
const chatsCollectionResponseSchema = createJsonApiCollectionResponseSchema(chatResourceSchema);
...
chatsRegistry.register('ChatsCollectionResponse', chatsCollectionResponseSchema);
...
chatsRegistry.register('MessagesCollectionResponse', messagesCollectionResponseSchema);
