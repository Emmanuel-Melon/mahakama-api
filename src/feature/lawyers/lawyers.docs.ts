...
const lawyerResourceSchema = createJsonApiResourceSchema('lawyer', lawyerResponseSchema);
const lawyerSingleResponseSchema = createJsonApiSingleResponseSchema(lawyerResourceSchema);
const lawyersCollectionResponseSchema = createJsonApiCollectionResponseSchema(lawyerResourceSchema);
...
lawyersRegistry.register('LawyersCollectionResponse', lawyersCollectionResponseSchema);
